...
function searchUsers() {
    ...
    allUsers.forEach(user => {
        // Chuyển cả họ tên và mã người dùng thành chữ thường để so sánh
        const hoTen = user.ho_ten.toLowerCase();
        const maNguoiDung = user.ma_nguoidung.toLowerCase();

        // Kiểm tra nếu chuỗi tìm kiếm xuất hiện trong họ tên hoặc mã người dùng
